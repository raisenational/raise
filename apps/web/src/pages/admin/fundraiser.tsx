...
const downloadFn = (data: Record<string, unknown>[] | undefined, name: string) => (data
	? async () => {
...
const DonationsSummaryView: React.FC<{fundraiserId: string; fundraiser?: Fundraiser}> = ({fundraiserId, fundraiser}) => {
	...
	return (
		<>
			...
			<Modal open={exportModalOpen} onClose={() => {
			...
			<Modal open={newDonationModalOpen} onClose={() => {
