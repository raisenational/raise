...
const IndexPage = () => (
  <Page>
    <Helmet>
      <title>Raise Leeds</title>
      <meta property="og:title" content="Raise Leeds" />
    </Helmet>
    <Cover>
      <Navigation
        left={[
    ...
    <Section id="faq">
      ...
      <FAQs>
        <FAQ title="How can I get involved?">
          ...
          {/* <p><b>Spread the word:</b> Letting your friends know about Raise is one of the most valuable things you can do - aside from the huge impact of their donations, celebrating is more fun when we do it together! Why not show them our website, share our posts on social media, and invite friends to follow our <a href="https://www.facebook.com/raiseleeds">Facebook</a> and <a href="https://www.instagram.com/raiseleeds/">Instagram</a> pages themselves?</p> */}
          <p>
            <b>Committee:</b>
            {' '}
            If you want to shape the future of Raise, apply to join our committee which coordinates everything we do, from events and partnerships to fundraising and publicity. Applications for the next academic year are open
            {' '}
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSfTckJoVhb397uFG2l54fiyDzuLyGQxgdylnNfc_J9TOP8kXg/viewform">here</a>
            , and we're always interested in hearing from people who want to get involved!
          </p>
          <p>
            <b>Sponsorship:</b>
            {' '}
            The support of our generous partners is invaluable for helping us to put on our summer celebration at the end of each year. If you know anyone who may be interested in supporting Raise and allowing us to grow even more, please do
            {' '}
        ...
        <FAQ title="£75 is a lot of money - what if I can't donate that?">
          <p>We recognise that £75 is a large amount of money for many students, and we have thought carefully about recommending this amount (see next question). It is important to us that any student feels able to join us in celebrating through giving.</p>
          <p>
            As such, while we recommend £75, you're encouraged to join Raise by making a donation of any size which is significant to you and allows you to put charity at the heart of your end-of-year celebrations. It is central to
            <a href="./#our-philosophy">our philosophy</a>
            {' '}
            that students actively engage with their decision to celebrate through giving, but we recognise that the donation that enables this will not be the same for everyone.
          </p>
        ...
        <FAQ title="Why do you recommend £75?">
          ...
          <p>
            ...
            {' '}
            Raise is all about changing the way students think about charity, and we can only achieve this if students engage consciously with the act of donating. By inviting students to give an amount that’s personally significant to them, we hope that all donors will stop and think meaningfully about their decision to donate, and will in turn take this positive, deliberate approach towards giving forward into their future lives. This is why we recommend £75, or a donation of any size significant to the donor.
          </p>
          <p>
            <b>Impact:</b>
            {' '}
            Crucially, the recommended amount, coupled with matched funding, allows us to have an exceptionally large impact for a student charity initiative; your £75 donation, when doubled, can help protect over 170 people from malaria.
          </p>
        </FAQ>
        ...
        <FAQ title="Why do you recommend donating to AMF?">
          <p>
            At Raise, we think very carefully about which charity to recommend. When students are making such significant donations, we want to make sure the money is doing as much good as it possibly can. To make our decision, we have taken the advice of independent charity evaluators
    ...
    <Section id="contact">
      ...
      <div className="inline-block text-left">
        <SocialIconV2 type="email" id="raiseleeds@gmail.com" />
        <SocialIconV2 type="instagram" id="raiseleeds" />
        <SocialIconV2 type="twitter" id="raiseleeds" />
      </div>
    </Section>
