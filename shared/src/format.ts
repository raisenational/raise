...
export const amountShort = (currency?: "gbp" | "usd" | null, amountInMinorUnits?: number | null): string => (currency === undefined || currency === null || amountInMinorUnits === undefined || amountInMinorUnits === null ? "—" : `${currencySymbol(currency)}${(amountInMinorUnits / 100).toFixed(amountInMinorUnits % 100 === 0 ? 0 : 2)}`)
