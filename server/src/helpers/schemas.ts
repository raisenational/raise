...
export const fundraiserEditsSchema = {
  ...
  properties: {
    ...
    matchFundingPerDonationLimit: { type: ["integer", "null"], minimum: 0 },
    matchFundingRemaining: { anyOf: [{ type: ["integer"], minimum: 0 }, { type: ["null"] }] },
    minimumDonationAmount: { type: ["integer", "null"], minimum: 0 },
