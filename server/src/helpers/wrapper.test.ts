...
describe("response body validation", () => {
  ...
  test.each([
    ...
    expect(response.body).toBe("{\"message\":\"An internal error occured\"}")
  })
})
...
describe("error handling", () => {
  describe.each([
    ...
    test.each([
      ...
      ["500", new createHttpError[500](errMessage), 500, "An internal error occured"],
      ["501", new createHttpError[501](errMessage), 501, "An internal error occured"],
      ["502", new createHttpError[502](errMessage), 502, "An internal error occured"],
      ["built-in JS", new Error(errMessage), 500, "An internal error occured"],
