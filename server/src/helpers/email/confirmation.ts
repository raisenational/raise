                      ...
                      <td style="vertical-align:top;padding:0;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:8px;word-break:break-word;">
                                <div style="font-family:'Helvetica', 'Arial', sans-serif;font-size:20px;line-height:1.5;text-align:left;color:#000000;">Dear ${donation.donorName.split(" ")[0]},<br /><br /> Thank you so much for donating through ${fundraiser.publicName} this year and joining our community of students celebrating positive, deliberate giving!<br /><br /> Your donation will help protect ${convert.moneyToPeopleProtected(fundraiser.currency, (donation.giftAid ? 1.25 : 1) * payments.reduce((acc, p) => acc + p.donationAmount + (p.matchFundingAmount ?? 0), 0))} people from malaria. We think that impact is something worth celebrating, and we look forward to seeing you at ${fundraiser.eventLink ? `<a href="${fundraiser.eventLink}">our Summer Party</a>` : "our Summer Party"}.<br /><br /> In the meantime, if you are keen to get more involved in our movement, check out our website for ways you can help or ${fundraiser.moreInvolvedLink ? `<a href="${fundraiser.moreInvolvedLink}" target="_blank">get in touch with us</a>` : "get in touch with us"}. Alternatively, you can follow us on social media to keep up to date during our donations period. Plus, the Summer Party is more fun with friends, so why not encourage them to join too?<br /><br /> We're looking forward to celebrating our collective impact with you soon!<br /><br /> Best wishes,<br /> The ${fundraiser.publicName} Team</div>
                              </td>
                            </tr>
                          </tbody>
                        </table>
