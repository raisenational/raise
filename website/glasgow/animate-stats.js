...
animateNumber(raisedElement, 0, 9201, integerPoundsFormatter, 3000, easingFunctions.linear);
const peopleProtectedElement = document.getElementById('people-protected-number');
animateNumber(peopleProtectedElement, 0, 11646, standardIntegerFormatter, 4000, easingFunctions.linear);
