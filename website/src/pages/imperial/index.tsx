...
const IndexPage = () => (
  <Page>
    <Helmet>
      <title>Raise Imperial</title>
      <meta property="og:title" content="Raise Imperial" />
    </Helmet>
    <Cover>
      <Navigation
        left={[
          { text: "Home", href: "/imperial/" },
          { text: "How It Works", href: "/imperial/#how-it-works" },
          { text: "FAQs", href: "/imperial/#faq" },
          { text: "Our Philosophy", href: "/imperial/#our-philosophy" },
    ...
    <Section id="faq">
      ...
      <FAQs>
        <FAQ title="Sounds great, where do I sign up?">
          <p>Awesome! Our committee applications period for is now closed, but you can follow us on <a href="https://www.facebook.com/raiseimperial">Facebook</a> to keep up to date with the latest opportunities.</p>
        </FAQ>
        ...
        <FAQ title="Why do you recommend £100?">
          ...
          <p><b>Impact:</b> Crucially, the recommended amount, coupled with matched funding, allows us to have an exceptionally large impact for a student charity initiative; your £100 donation, when doubled, can help protect over 170 people from malaria.</p>
        </FAQ>
    ...
    <Section id="contact">
      ...
      <div className="flex justify-center gap-8">
        <SocialIcon icon={instagram} alt="Instagram" href="https://www.instagram.com/raiseimperial/" />
        <SocialIcon icon={facebook} alt="Facebook" href="https://www.facebook.com/raiseimperial" />
        <SocialIcon icon={email} alt="Email" href="mailto:raiseimperial@gmail.com" />
      </div>
