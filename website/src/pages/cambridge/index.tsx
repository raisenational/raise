    ...
    <Section id="faq" className="mb-16 lg:mb-32">
      ...
      <FAQs>
        <FAQ title="How can I get involved?">
          <p>We're so pleased you're interested in MWA, and look forward to celebrating with you! Here are a few ways you can help grow the movement:</p>
          <p><b>Spread the word:</b> Letting your friends know about MWA is one of the most valuable things you can do - aside from the huge impact of their donations, celebrating is more fun when we do it together! Why not show them our website, share our posts on social media, and invite friends to follow our <a href="https://www.facebook.com/mayweekalternative">Facebook</a> and <a href="https://www.instagram.com/mayweekalternative">Instagram</a> pages themselves?</p>
          <p><b>Committee:</b> If you really want to shape the future of MWA, you could apply to join our committee, which coordinates everything we do, from events and partnerships to fundraising and publicity. Applications for the next academic year will open in the spring, but we're always interested in hearing from people who want to get involved - register your interest <a href="https://docs.google.com/forms/d/e/1FAIpQLSciX_CSJm47pwbuPvqoE2QMNKDZ_iv4zNJ6Z9vppWXu67TGFg/viewform">here</a>!</p>
          <p><b>MWA Reps:</b> Becoming an MWA rep is a low-commitment and flexible role for people who want to spread the message in their college, society or social group. Applications for next academic year will open in May Week, but we're always interested in hearing from people who want to get involved - register your interest <a href="https://docs.google.com/forms/d/e/1FAIpQLSenBKac-dDzWy_LcZXrG0nZ6NAlBH45FBuxhuiPuHNQV7FXWw/viewform">here</a>!</p>
          <p><b>Sponsorship:</b> In order to put on our Summer Party at the end of each year, we rely entirely on the support of our generous partners, including Cambridge colleges, businesses and individuals. If you know anyone who may be interested in supporting MWA and allowing us to grow even more, please do <a href="#contact">get in touch</a> or visit our <a href="./partner/">Partner page</a> for more info.</p>
        </FAQ>
        ...
        <FAQ title="Why do you recommend £150?">
          <p>We recognise that £150 is a large amount of money, and substantially more than most students would routinely donate to charity (indeed, that is part of the point!). There are a couple of key reasons we recommend this figure:</p>
          <p><b>Encouraging considered giving:</b> MWA is all about changing the way students think about charity, and we can only achieve this if students engage consciously with the act of donating. By inviting students to give an amount that’s personally significant to them, we hope that all donors will stop and think meaningfully about their decision to donate, and will in turn take this positive, deliberate approach towards giving forward into their future lives. This is why we recommend £150, or a donation of any size significant to the donor.</p>
          <p><b>Impact:</b> Crucially, the recommended amount, coupled with matched funding, allows us to have an exceptionally large impact for a student charity initiative; your £150 donation, when doubled, can help protect over 350 people from malaria.</p>
          <p><b>May Week Symbolism:</b> The £150 figure is representative of the cost of some May Ball tickets - this is symbolic of our belief that charity can be embraced as an integral part of May Week, on a par with May Balls.</p>
        </FAQ>

        <FAQ title="I'm already going to a May Ball. Is MWA really for me? (Hint: yes, definitely!)">
          <p>Of course, MWA is for everyone - whether you're going to three May Balls or none, we welcome you to join our growing community and put charity at the heart of your May Week celebrations. MWA is an alternative way to celebrate during May Week, but that doesn't mean you can't take part in other things going on!</p>
        </FAQ>

        <FAQ title="Can I donate to a different charity?">
          <p>At MWA, we think very carefully about which charity to recommend (see below), particularly given how much money students are donating. However, we recognise that some students may want to join us in celebrating through giving, but would prefer to donate to a different charity. This is absolutely fine, but please get in touch with us beforehand so that we are aware.</p>
        ...
        <FAQ title="Why do you recommend donating to AMF?">
          <p>At MWA, we think very carefully about which charity to recommend. When students are making such significant donations, we want to make sure the money is doing as much good as it possibly can. To make our decision, we have taken the advice of independent charity evaluators <a href="https://www.givewell.org/charities/top-charities">GiveWell</a> and <a href="https://www.givingwhatwecan.org">Giving What We Can</a>, which both rank AMF as one of the most effective charities in the world.</p>
          <p>Tragically, malaria causes 400,000 preventable deaths every year, disproportionately affecting young children and pregnant women, and has a knock-on effect on the local economy. AMF works with local partners to provide life-saving bed-nets which protect people as they sleep. To find out more about their work, see <a href="https://www.againstmalaria.com/">AMF's website</a>. The specific net distributions for which we have funded nets can be seen on <a href="https://www.againstmalaria.com/FundraiserGroup.aspx?FundraiserID=8339">MWA's dedicated AMF page</a>.</p>
          <p>Because AMF's intervention is so effective at preventing malaria, each donation can have a huge impact. For example, a donation of £150, doubled through matched funding, can help protect 350 people. In fact, the money MWA raised in 2021 was enough to protect over 88,000 people - or 3.6 people for every Cambridge student!</p>
        </FAQ>

        <FAQ title="What makes MWA different to a charity ball?">
          <p>At MWA, our mission is to encourage students to adopt a positive, deliberate approach towards giving. As such, we focus on ensuring that each student who chooses to join can engage meaningfully with the impact of their donation. The primary role of the Summer Party is to facilitate this engagement, as an enjoyable opportunity to come together as a community and celebrate our collective impact. However, it is not the most important element of what we do, nor the purpose of donating.</p>
          <p>Crucially, the donation students make to join MWA does not constitute ‘buying a ticket’ to the party. Indeed, the funding of our summer celebration is completely separate to the donation (it’s funded through a combination of additional voluntary contributions from donors and external sponsorship). Many students have joined MWA without attending the Summer Party at all.</p>
        </FAQ>
