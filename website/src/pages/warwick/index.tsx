...
const IndexPage = () => (
  <Page>
    <Helmet>
      <title>Raise Warwick</title>
      <meta property="og:title" content="Raise Warwick" />
    </Helmet>
    <Cover>
      <Navigation
        left={[
    ...
    <Section id="faq">
      ...
      <FAQs>
        <FAQ title="Sounds great, where do I sign up?">
          <p>Awesome! Our committee applications period for is now closed, but you can follow us on <a href="https://www.facebook.com/raisewarwick">Facebook</a> to keep up to date with the latest opportunities.</p>
        </FAQ>
    ...
    <Section id="contact">
      ...
      <div className="flex justify-center gap-8">
        <SocialIcon icon={instagram} alt="Instagram" href="https://www.instagram.com/raisewarwick/" />
        <SocialIcon icon={facebook} alt="Facebook" href="https://www.facebook.com/raisewarwick" />
        <SocialIcon icon={email} alt="Email" href="mailto:raisewarwick@gmail.com" />
      </div>
