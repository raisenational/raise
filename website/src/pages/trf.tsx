  ...
  <Page>
    ...
    <Section className="px-8">
      ...
      <div className="mt-16 p-6 rounded shadow-raise text-left bg-white text-black">
        <p>
          One particularly impactful way to do this is by taking a <span className="font-bold">future giving pledge</span> - a sustainable and meaningful commitment to give a portion of your future salary to helping others.
        </p>
              ...
              <div className="text-2xl font-normal">
                ...
                <ul className="list-disc ml-6">
                  <li className="mt-4 mb-2">
                    <span className="font-bold">The GWWC Pledge:</span> If you would like to make deliberate giving a part of your future life, Giving What We Can recommend pledging to donate around 10% of your future income towards high-impact causes (though this is flexible, see below).
                  </li>
                  <li className="mb-4">
                    <span className="font-bold">Trial Pledge:</span> If you want to test how a pledge fits into your life before committing, Giving What We Can also run a Trial Pledge, where you can try giving a smaller % for a limited time before deciding whether you want to continue with a long-term pledge.
                  </li>
                </ul>
                <p>
    ...
    <Section id="faq">
      ...
      <FAQs>
        <FAQ title="I'm uncertain about my future income or plans. Should I still pledge?">
          <p>
            All pledges are <span className="font-bold">self-administered</span> and <span className="font-bold">not legally binding</span> - you make donations each year and self-report them. You can update your pledge amount or withdraw from the pledge at any time if your personal circumstances change.
          </p>
          <p>
        ...
        <FAQ title="I'm confident that I'll continue to give regardless. Why should I pledge now?">
          <p>
            It's great you want to give! Even if you are relatively confident that you'll continue to give in the future, taking a pledge can still be useful, as you'll have a huge impact locked in with the support, commitment mechanism and community of <Link href="https://www.givingwhatwecan.org/">Giving What We Can</Link>.
          </p>
          <p>
            <span className="font-bold">Commitment:</span> Taking a pledge can be a useful 'pre-commitment mechanism' to help you stick to your goal of giving. Evidence shows that this sort of commitment can be an effective psychological mechanism to help our future selves live up to our values.
          </p>
          <p>
            <span className="font-bold">Community:</span> Joining Giving What We Can makes you part of a global community of wonderful givers, all passionate about making an impact, just like you. Donating alongside others can make the experience more personally rewarding, and can also positively reinforce positive behavioural change.
          </p>
          <p>
            <span className="font-bold">Culture:</span> Psychological research suggests that we are more likely to act altruistically if we know that others are doing so; taking a pledge can therefore help to normalise deliberate giving for those around us. In this way, your donations not only have a significant direct impact, but also contribute towards a wider culture of giving.
          </p>
          <p>
