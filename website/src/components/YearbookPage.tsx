...
const YearbookPage: React.FC<{ brand: string }> = ({ brand }) => {
      ...
      <Section id="faq">
        ...
        <FAQs>
          <FAQ title={`How can I stay involved with ${brand}?`}>
            <p>We'd love to keep in touch, and continue celebrating positive, deliberate and effective giving as you go out and do exciting things! Come and join <Link href="/alumni/">our alumni community</Link> to stay up to date with the latest news, events and opportunities.</p>
          </FAQ>

          <FAQ title={`Where do I learn more about ${brand}?`}>
            <p>We're excited you're interested in {brand}! For more details on what it is we do, see <Link href="/">our main website</Link>!</p>
          </FAQ>
