...
const ChaptersPage = () => (
  <Page>
    ...
    <Section className="text-left">
      ...
      <p>We operate at {CHAPTERS.length} UK universities. We call each local Raise group a chapter. If there isn't a Raise chapter at your university yet, we'd love to <Link href="#starting-a-chapter">help you start one</Link>.</p>
