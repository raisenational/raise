	...
	<Page>
		...
		<Section id="how-it-works" className="mt-0">
			...
			<div className="grid gap-5 md:grid-cols-3 md:gap-8">
				<Panel
					...
					title="Donate"
					text={`We invite students to make a personally significant donation to charity. We recommend a donation of ${format.amountShort(
						...ANCHOR
					)} to the Against Malaria Foundation, but welcome any amount that is significant to you.`}
					className="bg-raise-purple"
				/>
				<Panel
					image={<Doubled className="h-16 mb-4" />}
					title="Doubled"
					text={`Thanks to our matched funding, 200% of the money you donate goes directly to AMF. That means that your ${format.amountShort(
						...ANCHOR
					)}, when doubled, can help protect over ${convert.moneyToPeopleProtected(
						ANCHOR[0],
						ANCHOR[1] * 2
					)} people from malaria!`}
		...
		<Section id="faq">
			...
			<FAQs>
				<FAQ title="How can I get involved?">
					...
					<p>
						<b>Committee:</b> If you want to shape the future of Raise, apply to
				...
				<FAQ
					title={`${format.amountShort(
						...ANCHOR
					)} is a lot of money - what if I can't donate that?`}
				>
					<p>
						We recognise that {format.amountShort(...ANCHOR)} is a large amount
					...
					<p>
						As such, while we recommend {format.amountShort(...ANCHOR)}, you're
						...
						<a href="./#our-philosophy">our philosophy</a> that students
					...
					<p>
						...
						about {format.amountShort(...ANCHOR)}, which will still be doubled
				...
				<FAQ title={`Why do you recommend ${format.amountShort(...ANCHOR)}?`}>
					...
					<p>
						...
						we recommend {format.amountShort(...ANCHOR)}, or a donation of any
					...
					<p>
						...
						a student charity initiative; your {format.amountShort(...ANCHOR)}{" "}
						donation, when doubled, can help protect over $
						{convert.moneyToPeopleProtected(ANCHOR[0], ANCHOR[1] * 2)} people
						from malaria.
					</p>
				</FAQ>
				...
				<FAQ title="Why do you recommend donating to AMF?">
					...
					<p>
						...
						{format.amountShort(...ANCHOR)}, doubled through matched funding,
						can help protect{" "}
						{convert.moneyToPeopleProtected(ANCHOR[0], ANCHOR[1] * 2)} people.
		...
		<Section id="contact">
			...
			<div className="inline-block text-left">
				<SocialIconV2 type="email" alt="Email" id="raiseedinburgh@gmail.com" />
				<SocialIconV2
					type="instagram"
					alt="Instagram"
					id="raiseedinburgh"
					linkTextOverride="Raise Edinburgh!"
				/>
				<SocialIconV2
					type="facebook"
					alt="Facebook"
