  ...
  <Page>
    ...
    <Section id="faq">
      ...
      <FAQs>
        <FAQ title="Sounds great, where do I sign up?">
          <p>Awesome! Our committee applications period for is now closed, but you can follow us on <a href="https://www.facebook.com/raisesheff">Facebook</a> to keep up to date with the latest opportunities.</p>
        </FAQ>
    ...
    <Section id="contact">
      ...
      <div className="flex justify-center gap-8">
        <SocialIcon icon={instagram} alt="Instagram" href="https://www.instagram.com/raisesheff/" />
        <SocialIcon icon={facebook} alt="Facebook" href="https://www.facebook.com/raisesheff" />
        <SocialIcon icon={email} alt="Email" href="mailto:raisesheffield@gmail.com" />
      </div>
