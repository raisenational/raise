  ...
  <Page>
    ...
    <Section id="how-it-works" className="mt-0">
      ...
      <div className="grid gap-5 md:grid-cols-3 md:gap-8">
        <Panel
          ...
          title="Donate"
          text="We invite students to make a personally significant donation to charity. We recommend a donation of £50-£75 to the Against Malaria Foundation, but welcome any amount that is significant to you."
          className="bg-raise-purple"
        />
        <Panel
          image={<Doubled className="h-16 mb-4" />}
          title="Doubled"
          text="Thanks to our matched funding, 200% of the money you donate goes directly to AMF. That means that your £75, when doubled, can help protect over 175 people from malaria!"
    ...
    <Section id="faq">
      ...
      <FAQs>
        ...
        <FAQ title="£50-£75 is a lot of money - what if I can't donate that?">
          <p>We recognise that £50-75 is a large amount of money for many students, and we have thought carefully about recommending this amount (see next question). It is important to us that any student feels able to join us in celebrating through giving.</p>
          <p>As such, while we recommend £50-£75, you're encouraged to join Raise by making a donation of any size which is significant to you and allows you to put charity at the heart of your end-of-year celebrations. It is central to <a href="./#our-philosophy">our philosophy</a> that students actively engage with their decision to celebrate through giving, but we recognise that the donation that enables this will not be the same for everyone.</p>
        ...
        <FAQ title="Why do you recommend £50-£75?">
          <p>We recognise that this is a large amount of money, and substantially more than most students would routinely donate to charity (indeed, that is part of the point!). There are a couple of key reasons we recommend this figure:</p>
          <p><b>Encouraging considered giving:</b> Raise is all about changing the way students think about charity, and we can only achieve this if students engage consciously with the act of donating. By inviting students to give an amount that’s personally significant to them, we hope that all donors will stop and think meaningfully about their decision to donate, and will in turn take this positive, deliberate approach towards giving forward into their future lives. This is why we recommend £50-£75, or a donation of any size significant to the donor.</p>
          <p><b>Impact:</b> Crucially, the recommended amount, coupled with matched funding, allows us to have an exceptionally large impact for a student charity initiative; your £75 donation, when doubled, can help protect over 175 people from malaria.</p>
        </FAQ>
        ...
        <FAQ title="Why do you recommend donating to AMF?">
          ...
          <p>Because AMF's intervention is so effective at preventing malaria, each donation can have a huge impact. For example, a donation of £75, doubled through matched funding, can help protect 175 people. In fact, the money we raised nationally in 2020 was enough to protect over 120,000 people!</p>
        </FAQ>
