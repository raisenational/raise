    ...
    <Section id="faq">
      ...
      <FAQs>
        <FAQ title="How can I get involved?">
          ...
          <p><b>Raise Reps:</b> Reps are ambassadors for Raise, and a central part of Raise’s community, helping to share our philosophy and what we do with the Oxford community. <a href="https://forms.gle/f22GkSokt38hSfd48">Click here</a> to find out more about the rep role and to sign up.</p>
          ...
          <p><b>Committee:</b> If you really want to shape the future of Raise, you could apply to join our committee, which coordinates everything we do, from events and partnerships to fundraising and publicity. Applications are now closed for our 2022/23 committee, but look out for applications reopening in Trinity 2023!</p>
        ...
        <FAQ title="What is a Raise Rep, and what do they do?">
          <p>Reps are a central part of Raise’s community and are crucial to the growth of the movement. As a rep, you have the opportunity to help spread the Raise message, and we'll give you lots of support to do this. You might spread our message through:</p>
          <p><b>Conversations:</b> The most important part of the role! Talk about Raise with others in your college, departments, and social groups - the ask is significant and requires some thought, so this is how most people come to join.</p>
          ...
          <p><a href="https://forms.gle/f22GkSokt38hSfd48">Sign up</a> to be a rep.</p>
        </FAQ>
        ...
        <FAQ title="£150 is a lot of money - what if I can't donate that?">
          ...
          <p>As such, whilst we recommend £150, you are welcome to join Raise by making a donation of a size which is significant to you and allows you to put charity at the heart of your end-of-year celebrations. It is central to our philosophy (see <a href="./#our-philosophy">here</a> for more) that students actively engage with their decision to celebrate through giving, but we recognise that the donation that enables this will not be the same for everyone.</p>
          <p>In addition, you have the option of donating in weekly installments, as some have found this more manageable. A weekly donation of £5 from the donations launch up until our summer celebration adds up to about £150, which will still be doubled through our matched funding.</p>
        ...
        <FAQ title="Why do you recommend £150?">
          ...
          <p><b>Ball Symbolism:</b> The £150 figure is representative of the cost of many ball tickets - this is symbolic of our belief that charity can be embraced as an integral part of Trinity celebrations, on a par with balls.</p>
        </FAQ>

        <FAQ title="I'm already going to a ball. Is Raise really for me? (Hint: yes, definitely!)">
          <p>Of course, Raise is for everyone - whether you're going to three balls or none, we welcome you to join our growing community and put charity at the heart of your celebrations. Raise is an alternative way to celebrate, but that doesn't mean you can't take part in other things going on!</p>
        </FAQ>
        ...
        <FAQ title="Why do you recommend donating to AMF?">
          ...
          <p>Because AMF's intervention is so effective at preventing malaria, each donation can have a huge impact. For example, a donation of £150, doubled through matched funding, can help protect 350 people. In fact, the money we raised nationally in 2020 was enough to protect over 120,000 people!</p>
        </FAQ>
