        ...
        description: (
          <p>
            ...
            <span className="italic">
              ...
              <Link className="underline text-inherit" target="_blank" href="https://www.givewell.org/charities/give-directly/November-2020-version">source</Link>
              )
            </span>
          </p>
        ),
        ...
        description: (
          <p>
            ...
            <span className="italic">
              ...
              <Link className="underline text-inherit" target="_blank" href="https://founderspledge.com/research/fp-climate-change">source</Link>
              {' '}
              page 88)
            </span>
          </p>
        ...
        description: (
          <p>
            ...
            <span className="italic">
              ...
              <Link className="underline text-inherit" target="_blank" href="https://founderspledge.com/stories/mental-health-report-summary">source</Link>
              )
            </span>
          </p>
        ),
        ...
        description: (
          <p>
            ...
            <span className="italic">
              ...
              <Link className="underline text-inherit" target="_blank" href="https://forum.effectivealtruism.org/posts/uH9akQzJkzpBD5Duw/what-you-can-do-to-help-stop-violence-against-women-and">source</Link>
              )
            </span>
          </p>
        ),
        ...
        description: (
          <p>
            ...
            <span className="italic">
              ...
              <Link className="underline text-inherit" target="_blank" href="https://www.givewell.org/charities/amf">source</Link>
              )
            </span>
          </p>
        ),
